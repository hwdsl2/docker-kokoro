...
所有變數均為選填。設定 `KOKORO_API_KEY` 可啟用 Bearer Token 驗證。
...
**另請參閱：[Docker AI Stack](https://github.com/hwdsl2/docker-ai-stack)** — 一鍵部署完整 AI 技術堆疊的 docker-compose 設定和流水線範例。了解更多關於完整 AI 技術堆疊的部署方法。
